...
public class WordlePage extends JFrame
{
    //------------ JComps ------------
    ...
    public static boolean classicEnabled, endlessEnabled;
    ...
    public class TextFieldListener implements ActionListener
    {
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            if (attemptsCounter == 5)
            {
                ...
                new javax.swing.Timer(1500, evt ->
                {
                    ...
                    if ((statusArray[0] == true) && (statusArray[1] == true) && (statusArray[2] == true) && (statusArray[3] == true) && (statusArray[4] == true))
                    {
                        ...
                        if (classicEnabled == true)
                        {
                            playerVictory = true;
                            new GameResultsPage();
                        }

                        if (endlessEnabled == true)
                        {
            ...
            String guessedWord = enterText.getText().toUpperCase();
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        if ( (previousWords.contains(guessedWord)) || ( (endlessEnabled == true) && (HomePage.universalPreviousWords.contains(guessedWord)) && (Word.masterListString.contains(guessedWord) == false) ) )
                        {
    ...
    {
        SwingUtilities.invokeLater(WordlePage::new);
    }
}