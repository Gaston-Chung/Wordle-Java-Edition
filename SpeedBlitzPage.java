...
public class SpeedBlitzPage extends JFrame
{
    //------------ JComps ------------
    ...
    public static int timeLeft = GameModePage.startingTime;
    ...
    //Speed
    public static boolean speedBlitzEnabled;

    public ArrayList <String> previousWords = new ArrayList<String>();
    
    //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    public SpeedBlitzPage(int timeLeft)
    {
        ...
        timeLabel.setPreferredSize(new Dimension(180, 70));
        timeLabel.setBorder(BorderFactory.createLineBorder(Color.BLACK, 3));
        timeLabel.setBounds(25, 175, 215, 40);
        ...
        timer.start(); //Start as soon as the page is loaded
            ...
            if (attemptsCounter == 5)
            {
                ...
                new javax.swing.Timer(1500, evt ->
                {
                    ...
                    if ((statusArray[0] == true) && (statusArray[1] == true) && (statusArray[2] == true) && (statusArray[3] == true) && (statusArray[4] == true))
                    {
                        ...
                        //ONLY HERE do we generate a new SpeedBlitzPage with the OLD time and not the universal time of 300 seconds
                        if (speedBlitzEnabled == true)
                        {
                            GameModePage.startingTime = timeLeft;
                            new SpeedBlitzPage(timeLeft);
                            dispose();
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            //As long as the user entered a valid word that wasn't the correct answer, -5 seconds
                            timeLeft -= 5;
                            timeLabel.setText("⏰ Time Left: " + timeLeft);
                        }
                    }
